...
function CargoRegister({ data, setData, toast, can }) {
  ...
  const [confirmDelete,setConfirmDelete]=useState(null);
  const emptyForm={receivingDate:today(),description:"",unitKg:"",unitPrice:"",qty:"",spec:"",senderName:"",senderLocation:"",senderContact:"",receiverName:"",receiverLocation:"",receiverContact:"",paymentMethod:"Cash",amount:"",amountPaid:""};
