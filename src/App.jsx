...
function Reports({ cargo, tickets, bookings }) {
  ...
  const kpis=[{name:"Cargo Revenue (SSP)",actual:cR,target:15000000,owner:"Operations"},{name:"Ticket Revenue ($)",actual:tR,target:5000000,owner:"Ticketing"},{name:"Booking Revenue (SSP)",actual:bR,target:3000000,owner:"Booking"},{name:"Total Transactions",actual:txns,target:80,owner:"All Depts"},{name:"Combined Revenue (SSP)",actual:total,target,owner:"Finance"}];
  return (
    <div>
